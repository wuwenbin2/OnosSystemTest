...
class FUNCovsdbtest:
    ...
    def CASE1( self, main ):
        ...
        #main.ONOS1.handle.sendline( "/opt/onos/bin/onos-service start")
        print main.nodes[0].ip_address
    ...
    def CASE4( self, main ):
        ...
        if re.search( OVSDB1Ip, response ) and re.search( "true", response ):
            stepResult = main.TRUE
        else:
            stepResult = main.FALSE
        utilities.assert_equals( expect=main.TRUE,
        ...
        response = main.ONOScli1.devices()
        if re.search( OVSDB2Ip, response ) and re.search( "true", response ):
            stepResult = main.TRUE
        else:
            stepResult = main.FALSE
        utilities.assert_equals( expect=main.TRUE,
    ...
    def CASE8( self, main ):
        ...
        response = main.ONOScli1.devices()
        if re.search( OVSDB1Ip, response ) and  re.search( "false", response ):
            stepResult = main.TRUE
        else:
            stepResult = main.FALSE
        utilities.assert_equals( expect=main.TRUE,
        ...
        main.step( "Check onoscli devices have ovs " + str( OVSDB2Ip ) )
        response = main.ONOScli1.devices()
        if re.search( OVSDB2Ip, response ) and  re.search( "false", response ):
            stepResult = main.TRUE
        else:
            stepResult = main.FALSE
        utilities.assert_equals( expect=main.TRUE,
